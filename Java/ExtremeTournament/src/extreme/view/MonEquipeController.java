...
//                        tfphotourl.setText(path);
    ...
    public void ajouterequipe(ActionEvent event) throws FileNotFoundException, SQLException {
        ...
        e = new Equipe(f_nome.getText(), Integer.parseInt(f_nbe.getText()), Userconnected.getId(), f.getAbsolutePath(), catégorie, f_pass.getText());
...
//         f_path.clear();
    ...
    private void afficherMesEquipe() throws SQLException {
        ...
        data.clear();
        ObservableList<Equipe> data = r.afficherMonEquipe(Userconnected.getId());
    ...
    void selected_item(MouseEvent event) {
        ...
        f_pass.setText(col_passw.getCellData(index).toString());
    ...
    public void ConsulterMonEquipe(ActionEvent event) throws IOException, SQLException {
         ...
         FXMLLoader LOADER = new FXMLLoader(getClass().getResource("/extreme/view/GérerMonEquipe.fxml"));
         Parent root = LOADER.load();
        

            MonEquipe.getChildren().removeAll();
            MonEquipe.getChildren().setAll(root);
   //    Parent root = LOADER.load();
...
//    }
    @FXML
    private void Modifiermonequipe(ActionEvent event) throws SQLException {
        ...
        if (result.get() == ButtonType.OK) {
            ...
            String value1 = f_pass.getText();
            String value2 = f_nbe.getText();
            String value3 = tableEE.getSelectionModel().getSelectedItem().getNom_equipe();
            //String value3=f_path.getText();

            PreparedStatement stm = connexion.prepareStatement("update equipe set Epass='" + value1 + "', nb_participants='" + value2 + "' where nom_equipe='" + value3 + "' ");
