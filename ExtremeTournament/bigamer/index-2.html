...
<body>
	...
	<div class="banner__slider overflow-hidden">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner" style="background-image: url(assets/images/banner/home-2/bg.jpg);">
                    <div class="container">
                        <div class="row g-0">
            ...
            <div class="swiper-slide">
                <div class="banner" style="background-image: url(assets/images/banner/home-2/bg-2.jpg);">
                    <div class="container">
                        <div class="row g-0">
                            <div class="col-lg-6 col-12">
                                <div class="banner__content">
		...
		<div class="container">
			...
			<div class="section-wrapper">
				...
				<div class="button-wrapper text-center mt-5">
					<a href="game-list.html" class="default-button"><span>Browse All games <i class="icofont-circled-right"></i></span> </a>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="match-section padding-top padding-bottom" style="background-image:url(assets/images/match/bg-2.jpg)">
		<div class="container">
			<div class="section-header">
					...
					<div class="col-12">
						<div class="match-item item-layer">
							<div class="match-inner">
								...
								<div class="match-content bg-white">
											...
											<div class="match-game-info">
												...
												<p
													...
													<span class="match-date">30
														April 2022 </span><span class="match-time">Time: 08:30PM</span>
												</p>
											</div>
										</div>
	...
	<section class="player-section padding-top padding-bottom">
		<div class="container">
			<div class="section-header">
				<p>Our Team Players</p>
				<h2>Meet Our Squad Players
				</h2>
			</div>
			<div class="section-wrapper">
                <div class="row g-4">
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="player-item-2 text-center" style="background-image: url(assets/images/team/home-2/1.jpg);">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="player-item-2 text-center" style="background-image: url(assets/images/team/home-2/2.jpg);">
                            <div class="player-inner-2">
                                <div class="player-thumb-2">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="player-item-2 text-center" style="background-image: url(assets/images/team/home-2/3.jpg);">
                            <div class="player-inner-2">
                                <div class="player-thumb-2">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="player-item-2 text-center" style="background-image: url(assets/images/team/home-2/4.jpg);">
                            <div class="player-inner-2">
                                <div class="player-thumb-2">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="player-item-2 text-center" style="background-image: url(assets/images/team/home-2/5.jpg);">
                            <div class="player-inner-2">
                                <div class="player-thumb-2">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="cta-content">
								...
								<h2 class="mb-3">JOIN <span class="theme-color text-uppercase">Bi-Gamer</span> ESPORTS TO BECOME
									NEXT PRO Bi-GAMER TODAY!</h2>
						...
						<div class="col-lg-6">
							<div class="cta-thumb text-end">
								<img src="assets/images/cta/02.png" alt="Bi-gamer-img">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="product-item">
							<div class="product-inner">
								...
								<div class="product-content text-center p-3">
									<a href="#"><h5 class="product-title">Bi-Gamer T-Shirt Here</h5></a>
	...
	<div class="sponsor-section padding-top padding-bottom">
		<div class="container">
			<div class="section-header">
				<p>WE OUR PARTNERS</p>
				<h2>BECOME A PARTNER of Bi-Gamer</h2>
			</div>
			<div class="section-wrapper">
				...
				<div class="text-center mt-5">
					<a href="partners.html" class="default-button"><span>BECOME A PARTNER <i class="icofont-circled-right"></i></span> </a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="blog-section padding-top padding-bottom" style="background-image:url(assets/images/blog/bg.jpg)">
		<div class="container">
			<div class="section-header">
				<p>our recent news</p>
				...
				<div class="row g-4 justify-content-center row-cols-lg-2 row-cols-1">
						...
						<div class="blog-item">
							<div class="blog-inner">
								<div class="blog-thumb">
									<img src="assets/images/blog/home-2/01.jpg" alt="blog-thumb">
								</div>
								<div class="blog-content px-3 py-4">
									...
									<a href="blog-single.html" class="default-button reverse-effect"><span>read more <i class="icofont-arrow-right"></i></span></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="blog-item">
							<div class="blog-inner">
								<div class="blog-thumb">
									<img src="assets/images/blog/home-2/02.jpg" alt="blog-thumb">
								</div>
								<div class="blog-content px-3 py-4">
									<a href="blog-single.html"><h3>redefine resource maximizing for Distinctive</h3></a>
									<div class="meta-post">
										<a href="#">Admin</a>
										<a href="#">01 January 2022</a>
									</div>
	...
	<div class="testimonial-section padding-top padding-bottom" style="background-image:url(assets/images/testimonial/bg.png)">
		<div class="container">
			<div class="section-header">
				<p>our recent news</p>
									...
									<div class="testimonial-head">
										<div class="testi-top">
											<div class="testimonial-thumb">
												<img src="assets/images/testimonial/home-2/01.jpg" alt="testimonial">
											</div>
											<div class="name-des">
												<h5>Madley Pondor</h5>
												<p>UI Designer</p>
										...
										<a href="team-single.html"><img src="assets/images/testimonial/home-2/logo/01.png" alt="testimonial"></a>
									</div>
							...
							<div class="testimonial-item">
								<div class="testimonial-inner">
									<div class="testimonial-head">
										<div class="testi-top">
											<div class="testimonial-thumb">
												<img src="assets/images/testimonial/home-2/02.jpg" alt="testimonial">
											</div>
											<div class="name-des">
										...
										<a href="team-single.html"><img src="assets/images/testimonial/home-2/logo/02.png" alt="testimonial"></a>
									</div>
									<div class="testimonial-body">
