...
import static view.LoginController.Userconnected;
import view.CommentsController;
...
//    fid_publicationc.setText(c_id_pub.getCellData(index).toString());
    ...
    private void ajouterpublication(ActionEvent event) {
     ...
     String absolute =f.getAbsolutePath();
         ...
         p= new Publication(ftitre.getText(),fstatus.getText(),new java.sql.Date(System.currentTimeMillis()),f.getAbsolutePath(),20);
...
//    }
    ...
    private void upload(ActionEvent event) {
        ...
        fileChooser.setInitialDirectory(new File("C:\\Users\\ASUS\\Documents\\NetBeansProjects\\ExtremeTournament\\src\\css"));
