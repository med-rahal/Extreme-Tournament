...
//    fid_publicationc.setText(c_id_pub.getCellData(index).toString());
 ...
 ;
    ...
    private void ajouterpublication(ActionEvent event) throws SQLException {
     ...
     p= new Publication(ftitre.getText(),fstatus.getText(),new java.sql.Date(System.currentTimeMillis()),f.getAbsolutePath(),29);
 ...
 ObservableList<Commentaire> pb = cs.affichercomment();
  ...
  c= new Commentaire(ftext.getText(),new java.sql.Date(System.currentTimeMillis()),29);
Publication p = new Publication();
